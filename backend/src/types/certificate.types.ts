/**
 * @fileoverview Tipos TypeScript para el módulo de Certificación Automática
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para certificados, templates y validaciones
 *
 * Archivo: backend/src/types/certificate.types.ts
 */
