/**
 * @fileoverview Tipos TypeScript para el módulo de Gestión de Aforos
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para capacidad de eventos, tipos de acceso y control de aforos
 */
