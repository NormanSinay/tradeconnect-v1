/**
 * @fileoverview Tipos TypeScript para el panel administrativo - Inscripciones
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para inscripciones y asistencia en el panel administrativo
 */
