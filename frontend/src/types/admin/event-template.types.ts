/**
 * @fileoverview Tipos TypeScript para el panel administrativo - Plantillas de Eventos
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para plantillas de eventos en el panel administrativo
 */
