/**
 * @fileoverview Tipos TypeScript para el panel administrativo - QR y Control de Acceso
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para códigos QR, asistencia y control de acceso en el panel administrativo
 */

// Tipos locales para evitar dependencias del backend
export type QRStatus = 'ACTIVE' | 'USED' | 'EXPIRED' | 'REVOKED';
export type AttendanceMethod = 'qr_scan' | 'manual' | 'rfid' | 'biometric' | 'other';
export type AttendanceStatus = 'checked_in' | 'checked_out' | 'no_show' | 'cancelled';
export type AccessType = 'ENTRY' | 'EXIT' | 'VALIDATION' | 'VERIFICATION';
export type AccessResult = 'SUCCESS' | 'FAILURE' | 'DENIED' | 'ERROR';
export type AccessSeverity = 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
export type SyncStatus = 'PENDING' | 'PROCESSING' | 'COMPLETED' | 'FAILED';
export type ConflictResolution = 'offline_wins' | 'online_wins' | 'manual' | 'merge';
export type SyncPriority = 'LOW' | 'NORMAL' | 'HIGH' | 'URGENT';
