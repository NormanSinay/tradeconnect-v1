/**
 * @fileoverview Tipos TypeScript para el panel administrativo - Eventos
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para eventos, plantillas y sesiones en el panel administrativo
 */
