/**
 * @fileoverview Tipos TypeScript para el panel administrativo - Sesiones de Eventos
 * @version 1.0.0
 * @author TradeConnect Team
 * @description Definiciones de tipos para sesiones de eventos en el panel administrativo
 */
