...
import { FaPlus, FaSearch, FaFilter, FaDownload, FaTrash, FaEdit, FaEye, FaUsers, FaCheck, FaTimes, FaClock, FaFileInvoiceDollar, FaCalendarAlt } from 'react-icons/fa'
...
const AdminRegistrationsPage: React.FC = () => {
  ...
  return (
    <AdminLayout title="Gestión de Inscripciones" breadcrumbs={breadcrumbs}>
      <div className="space-y-6">
        {/* Header con acciones */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Inscripciones</h1>
            <p className="text-gray-600">Gestiona todas las inscripciones del sistema</p>
          </div>
