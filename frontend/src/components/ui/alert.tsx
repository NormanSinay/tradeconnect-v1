  ...
  'relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-current',
  {
    variants: {
      variant: {
        ...
        success:
          'border-success/50 text-success-dark bg-success/10 [&>svg]:text-success',
        warning:
          'border-warning/50 text-warning-dark bg-warning/10 [&>svg]:text-warning',
        info:
          'border-info/50 text-info-dark bg-info/10 [&>svg]:text-info',
      },
    },
    defaultVariants: {
      variant: 'default',
