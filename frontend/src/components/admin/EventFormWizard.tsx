/**
 * @fileoverview EventFormWizard - Asistente de formulario para creación/edición de eventos
 *
...
import { Calendar, Clock, MapPin, Users, DollarSign, Settings } from 'lucide-react';
